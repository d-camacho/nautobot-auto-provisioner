...
```no-highlight
> poetry version
nautobot-auto-provisioner 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/nautobot/nautobot-app-auto-provisioner/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/nautobot/nautobot-app-auto-provisioner/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/nautobot/nautobot-app-auto-provisioner/compare/v1.4.1...v1.4.2
```
